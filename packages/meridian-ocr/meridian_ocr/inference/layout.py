...
from meridian_ocr.inference import pdf_image as pdf_image_utils
...
from meridian_ocr.visualize import draw_bbox
...
class DocumentLayout:
    ...
    def from_image_file(
        cls,
        filename: str,
        detection_model: Optional[MeridianOCRObjectDetectionModel] = None,
        element_extraction_model: Optional[MeridianOCRElementExtractionModel] = None,
...
class PageLayout:
    ...
    def get_elements_with_detection_model(
        ...
        if self.detection_model is None:
            model = get_model()
            if isinstance(model, MeridianOCRObjectDetectionModel):
...
def process_file_with_model(
    ...
    **kwargs: Any,
    ...
    elif isinstance(model, MeridianOCRElementExtractionModel):
