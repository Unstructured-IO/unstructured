...
from meridian_ocr.constants import PDF_POINTS_PER_INCH
...
def convert_pdf_to_image(
    ...
    This is the single source of truth for PDF→image rendering across meridian_partition
    and meridian_ocr. Callers should pass their own DPI value explicitly.
    """
