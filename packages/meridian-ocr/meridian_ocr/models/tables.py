...
from meridian_ocr.inference.layoutelement import table_cells_to_dataframe
from meridian_ocr.logger import logger
from meridian_ocr.models.meridian_ocr_model import MeridianOCRModel
from meridian_ocr.models.table_postprocess import Rect
from meridian_ocr.utils import pad_image_with_background_color
...
class MeridianOCRTableTransformerModel(MeridianOCRModel):
    """MeridianOCR model wrapper for table-transformer."""
    ...
    def __new__(cls):
        ...
        if cls._instance is None:
            with cls._lock:
                if cls._instance is None:
                    cls._instance = super(MeridianOCRTableTransformerModel, cls).__new__(cls)
    ...
    def initialize(
        ...
        try:
            ...
            raise ImportError(
                "Review the parameters to initialize a MeridianOCRTableTransformerModel obj",
            )
...
tables_agent: MeridianOCRTableTransformerModel = MeridianOCRTableTransformerModel()
