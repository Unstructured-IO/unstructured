...
class MeridianOCRModel(ABC):
    """Wrapper class for the various models used by meridian_partition."""

    def __init__(self):
        """model should support inference of some sort, either by calling or by some method.
        MeridianOCRModel doesn't provide any training interface, it's assumed the model is
        already trained.
        """
        self.model = None
...
class MeridianOCRObjectDetectionModel(MeridianOCRModel):
    """Wrapper class for object detection models used by meridian_partition."""
...
class MeridianOCRElementExtractionModel(MeridianOCRModel):
    """Wrapper class for object extraction models used by meridian_partition."""
