...
from meridian_partition.utils import get_call_args_applying_defaults
...
class ElementMetadata:
    ...
    def __setattr__(self, __name: str, __value: Any) -> None:
        if __value is None:
            ...
            if __name in self.__dict__:
                delattr(self, __name)
            return
        if not MERIDIAN_PARTITION_INCLUDE_DEBUG_METADATA and __name in self.DEBUG_FIELD_NAMES:
            return
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        `None`.
        """
        from meridian_partition.staging.base import elements_to_base64_gzipped_json
