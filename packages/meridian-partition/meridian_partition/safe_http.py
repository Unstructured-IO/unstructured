...
_MAX_REDIRECTS = 10
_ENV_VAR = "MERIDIAN_PARTITION_ALLOW_PRIVATE_URL"
...
def _validate_url(url: str, allow_private: bool = False) -> None:
    ...
    ``MERIDIAN_PARTITION_ALLOW_PRIVATE_URL`` env var is truthy.
    """
...
def safe_get(
    ...
    **kwargs: Any,
    ...
    allow_private:
        ...
        ``MERIDIAN_PARTITION_ALLOW_PRIVATE_URL`` environment variable.
    **kwargs:
