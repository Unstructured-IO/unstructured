...
- The parser's design is _recursive_, consistent with the recursive (tree) structure of HTML. The
  ...
  MeridianPartition _document-elements_. In the parser code the term "document-element" is used when
...
from meridian_partition.partition.common.metadata import category_depth_from_html_tag
