...
from meridian_partition.documents.elements import Element, ElementMetadata, NarrativeText
...
from meridian_partition.utils import is_temp_file_path
...
def partition_audio(
    ...
    **kwargs: Any,
    ...
    ``pip install "meridian_partition[audio]"``.
