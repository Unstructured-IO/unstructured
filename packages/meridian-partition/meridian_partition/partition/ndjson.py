...
from meridian_partition.documents.elements import Element, Text, process_metadata
from meridian_partition.file_utils.filetype import FileType, add_metadata_with_filetype
from meridian_partition.partition.common.common import exactly_one
from meridian_partition.partition.common.json_partitioning import (
...
@partition_runtime_telemetry("ndjson")
@process_metadata()
...
def partition_ndjson(
    ...
    **kwargs: Any,
    ...
    - Rehydration: lines of serialized MeridianPartition elements are converted back into those
      elements.
    ...
    if all(is_element_shaped_dict(value) for value in values):
        # -- Branch A: rehydrate serialized MeridianPartition elements --
