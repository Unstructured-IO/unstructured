...
from meridian_partition.chunking import add_chunking_strategy
from meridian_partition.cleaners.core import (
...
from meridian_partition.errors import PageCountExceededError, UnprocessableEntityError
from meridian_partition.file_utils.model import FileType
from meridian_partition.logger import logger, trace_logger
from meridian_partition.nlp.patterns import PARAGRAPH_PATTERN
from meridian_partition.partition.common.common import (
...
from meridian_partition.partition.utils.sorting import coord_has_valid_points, sort_page_elements
from meridian_partition.patches.pdfminer import patch_psparser
from meridian_partition.telemetry import (
...
def _partition_pdf_or_image_with_ocr(
    ...
    **kwargs: Any,
    ...
    from meridian_partition.partition.pdf_image.pdf_image_utils import convert_pdf_to_images
...
def _partition_pdf_or_image_with_ocr_from_image(
    ...
    **kwargs: Any,
    ...
    """Extract `meridian_partition` elements from an image using OCR and perform partitioning."""
...
def document_to_element_list(
    ...
    **kwargs: Any,
    ...
    """Converts a DocumentLayout object to a list of meridian_partition elements."""
    from meridian_partition.partition.pdf_image.pdfminer_processing import get_links_in_element
