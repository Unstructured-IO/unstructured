...
from meridian_partition.documents.elements import DataSourceMetadata, Element
...
from meridian_partition.partition.common.lang import check_language_args
...
from meridian_partition.safe_http import safe_get
from meridian_partition.telemetry import partition_runtime_telemetry, set_partition_document_type
        ...
        for pkg_name in file_type.importable_package_dependencies:
            if not dependency_exists(pkg_name):
                raise ImportError(
                    ...
                    f' pip install "meridian_partition[{file_type.extra_name}]" (including quotes)'
