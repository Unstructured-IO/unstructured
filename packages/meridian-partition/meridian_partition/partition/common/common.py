...
from meridian_partition.documents.coordinates import CoordinateSystem, PixelSpace
...
def ocr_data_to_elements(
    ...
    """Convert OCR layout data into `meridian_partition` elements with associated metadata."""
