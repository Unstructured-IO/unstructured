...
from meridian_partition.cleaners.core import clean_bullets
...
from meridian_partition.partition.text_type import (
    is_bulleted_text,
    is_email_address,
...
class PicturePartitionerT(Protocol):
    ...
    `meridian_partition` `Image` element.
...
class DocxPartitionerOptions:
    ...
    def strategy(self) -> str:
        ...
        `meridian_partition.partition.utils.constants.PartitionStrategy` but resolve to str values.
        """
