...
"""Unit-test suite for the `meridian_partition.common.html_table` module."""
...
from meridian_partition.common.html_table import (
    HtmlCell,
    HtmlRow,
    HtmlTable,
...
class Describe_htmlify_matrix_of_cell_texts:
    """Unit-test suite for `meridian_partition.common.html_table.htmlify_matrix_of_cell_texts()`."""
...
class DescribeHtmlTable:
    """Unit-test suite for `meridian_partition.common.html_table.HtmlTable`."""
...
class DescribeHtmlRow:
    """Unit-test suite for `meridian_partition.common.html_table.HtmlRow`."""
...
class DescribeHtmlCell:
    """Unit-test suite for `meridian_partition.common.html_table.HtmlCell`."""
