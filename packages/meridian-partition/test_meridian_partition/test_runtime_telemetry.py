...
from meridian_partition import telemetry
...
def test_delivery_disables_environment_redirects_retries_and_body_download(
    ...
    session.get.assert_called_once_with(
        "https://packages.meridian_partition.io/python-telemetry",
        params=params,
        timeout=(0.5, 0.5),
...
def test_structured_remote_or_serialized_table_does_not_claim_local_extraction(captured_events):
    ...
    partition_json = _named_partitioner("partition_json", lambda: result, None)
