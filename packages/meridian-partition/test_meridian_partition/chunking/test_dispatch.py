...
"""Unit-test suite for the `meridian_partition.chunking.dispatch` module."""
...
from meridian_partition.chunking import add_chunking_strategy, register_chunking_strategy
from meridian_partition.chunking.dispatch import _ChunkerSpec, chunk
from meridian_partition.documents.elements import CompositeElement, Element, Text


class Describe_add_chunking_strategy:
    """Unit-test suite for `meridian_partition.chunking.add_chunking_strategy()` decorator."""
...
class Describe_chunk:
    """Unit-test suite for `meridian_partition.chunking.dispatch.chunk()` function."""
...
class Describe_ChunkerSpec:
    """Unit-test suite for `meridian_partition.chunking.dispatch._ChunkerSpec` objects."""
