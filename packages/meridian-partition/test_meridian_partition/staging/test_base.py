...
from meridian_partition.errors import DecompressedSizeExceededError
...
def test_elements_from_base64_gzipped_json_raises_error_if_decompression_exceeds_max_size():
    ...
    with (
        patch("meridian_partition.staging.base.MAX_DECOMPRESSED_SIZE", 32),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "test_meridian_partition/testfiles/staging/UDHR_first_article_all.txt.json",
            "test_meridian_partition/testfiles/staging/UDHR_first_article_all.txt.md",
        ),
        (
            "test_meridian_partition/testfiles/staging/embedded-images.pdf.json",
            "test_meridian_partition/testfiles/staging/embedded-images.pdf.md",
        ),
    ],
)
...
def test_create_file_from_elements_positional_no_group_by_page_backward_compat():
    ...
    with patch("meridian_partition.partition.html.convert.elements_to_html") as mock_html:
...
def test_element_to_md_with_none_mime_type():
    ...
    from meridian_partition.documents.elements import ElementMetadata, Image
