...
class DescribeFileType:
    """Unit-test suite for `meridian_partition.file_utils.model.Filetype`."""
    ...
    @pytest.mark.parametrize(
        ("file_type", "expected_value"),
        [
            (FileType.BMP, "meridian_partition.partition.image"),
            (FileType.CSV, "meridian_partition.partition.csv"),
            (FileType.DOC, "meridian_partition.partition.doc"),
            (FileType.DOCX, "meridian_partition.partition.docx"),
            (FileType.JPG, "meridian_partition.partition.image"),
            (FileType.PNG, "meridian_partition.partition.image"),
            (FileType.TIFF, "meridian_partition.partition.image"),
            (FileType.WAV, "meridian_partition.partition.audio"),
        ],
    )
...
def test_register_partitioner():
    ...
    assert file_type.partitioner_module_qname == "test_meridian_partition.file_utils.test_model"
