...
"""Test suite for `meridian_partition.partition.docx` module."""
...
from meridian_partition.partition.docx import (
...
class DescribeDocxPartitionerOptions:
    """Unit-test suite for `meridian_partition.partition.docx.DocxPartitionerOptions` objects."""
    ...
    def it_loads_the_docx_document(
        ...
        docx_Document_ = function_mock(
            request, "meridian_partition.partition.docx.docx.Document", return_value=document_
        )
    ...
    def get_last_modified_date_(self, request: FixtureRequest) -> Mock:
        return function_mock(request, "meridian_partition.partition.docx.get_last_modified_date")


class Describe_DocxPartitioner:
    """Unit-test suite for `meridian_partition.partition.docx._DocxPartitioner`."""
