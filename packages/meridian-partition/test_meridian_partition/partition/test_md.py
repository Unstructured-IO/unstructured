...
def test_partition_md_from_url():
    ...
    with patch("meridian_partition.partition.md.safe_get", return_value=response) as _:
...
def test_partition_md_from_url_raises_with_bad_status_code():
    ...
    with (
        patch("meridian_partition.partition.md.safe_get", return_value=response) as _,
