...
"""Unit-test suite for the `meridian_partition.partition.utils.ocr_models.ocr_interface` module."""
...
class DescribeOCRAgent:
    """Unit-test suite for `meridian_partition.partition.utils...ocr_interface.OCRAgent` class."""
    ...
    def and_it_raises_when_the_requested_agent_cannot_be_loaded(
        ...
        with (
            patch(
                "meridian_partition.partition.utils.ocr_models.ocr_interface.importlib.import_module",
