"""Test-suite for `meridian_partition.partition.ndjson` module."""
...
from meridian_partition.partition.ndjson import partition_ndjson
...
def test_partition_ndjson_from_file_path_gets_last_modified_from_filesystem(mocker: MockFixture):
    ...
    mocker.patch(
        "meridian_partition.partition.ndjson.get_last_modified_date",
