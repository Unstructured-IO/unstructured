...
"""Test suite for `meridian_partition.partition.html.partition` module."""
...
def test_partition_html_from_filename_pulls_last_modified_from_filesystem(request: FixtureRequest):
    get_last_modified_date_ = function_mock(
        request,
        "meridian_partition.partition.html.partition.get_last_modified_date",
...
def safe_get_(request: pytest.FixtureRequest):
    return function_mock(request, "meridian_partition.partition.html.partition.safe_get")
...
class DescribeHtmlPartitionerOptions:
    """Unit-test suite for `meridian_partition.partition.html.partition.HtmlPartitionerOptions`."""
    ...
    def get_last_modified_date_(self, request: FixtureRequest) -> Mock:
        return function_mock(
            request, "meridian_partition.partition.html.partition.get_last_modified_date"
        )


class Describe_HtmlPartitioner:
    """Unit-test suite for `meridian_partition.partition.html.partition._HtmlPartitioner`."""
