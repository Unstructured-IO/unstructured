...
"""Test suite for `meridian_partition.partition.html.parser` module."""
...
from meridian_partition.partition.html.parser import (
    Annotation,
    DefaultElement,
    Flow,
    Phrasing,
...
class DescribeFlow:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.Flow`.
...
class DescribePre:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.Pre`.
...
class DescribeRemovedBlock:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.RemovedBlock`.
...
class DescribePhrasing:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.Phrasing`.
...
class DescribeAnchor:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.Anchor`.
...
class DescribeBold:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.Bold`.
...
class DescribeItalic:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.Italic`.
...
class DescribeLineBreak:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.LineBreak`.
...
class DescribeRemovedPhrasing:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.RemovedPhrasing`.
...
class DescribeDefaultElement:
    """Isolated unit-test suite for `meridian_partition.partition.html.parser.DefaultElement`.
