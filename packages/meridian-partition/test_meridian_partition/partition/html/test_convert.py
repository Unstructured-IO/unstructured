...
from meridian_partition.documents.elements import Element, ElementMetadata, ElementType
from meridian_partition.partition.html.convert import (
    HTML_PARSER,
    ElementHtml,
    ImageElementHtml,
    LinkElementHtml,
...
def test_elements_to_html_tags_by_parent(
    ...
    mocker.patch(
        "meridian_partition.partition.html.convert._group_element_children",
...
def test_elements_to_html_tags(mocker: MockerFixture, elements: list[Element]) -> None:
    ...
    mocker.patch(
        "meridian_partition.partition.html.convert._elements_to_html_tags_by_parent",
        side_effect=lambda elements: elements,
    )
    mocker.patch(
        "meridian_partition.partition.html.convert.ElementHtml.get_html_element",
...
def test_elements_to_html_tags_by_page(mocker: MockerFixture, elements: list[Element]) -> None:
    ...
    mocker.patch(
        "meridian_partition.partition.html.convert._elements_to_html_tags",
        side_effect=_mock_elements_to_html_tags,
    )
    mocker.patch(
        "meridian_partition.partition.html.convert.group_elements_by_page",
...
def test_elements_to_html_no_group_by_page(
    ...
    mock_elements_to_html_tags_by_page = mocker.patch(
        "meridian_partition.partition.html.convert._elements_to_html_tags_by_page",
    )
...
def test_elements_to_html_invalid_html_template(
    ...
    mocker.patch(
        "meridian_partition.partition.html.convert.HTML_TEMPLATE",
