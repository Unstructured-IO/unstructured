...
from meridian_partition.partition.utils.ocr_models.google_vision_ocr import OCRAgentGoogleVision
from meridian_partition.partition.utils.ocr_models.ocr_interface import OCRAgent
from meridian_partition.partition.utils.ocr_models.paddle_ocr import OCRAgentPaddle
from meridian_partition.partition.utils.ocr_models.tesseract_ocr import (
    OCRAgentTesseract,
    zoom_image,
)
...
def test_supplement_layout_with_ocr(mock_ocr_get_instance, mocker, mock_page):
    from meridian_partition.partition.pdf_image.ocr import OCRAgent
...
def test_pass_down_agents(mock_ocr_get_instance, mocker, mock_page):
    from meridian_partition.partition.pdf_image.ocr import OCRAgent, PILImage
