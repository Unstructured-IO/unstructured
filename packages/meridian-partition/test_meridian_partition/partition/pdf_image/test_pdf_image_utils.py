...
def test_save_elements_with_output_dir_path_none(
    ...
    with (
        ...
        patch("meridian_partition.partition.pdf_image.pdf_image_utils.write_image"),
        patch("meridian_partition.partition.pdf_image.pdf_image_utils.convert_pdf_to_image"),
...
def test_annotate_layout_elements(filename, is_image):
    ...
    with (
        patch("PIL.Image.open"),
        patch(
            "meridian_partition.partition.pdf_image.pdf_image_utils.convert_pdf_to_image",
            return_value=["/path/to/image1.jpg", "/path/to/image2.jpg"],
        ) as mock_pdf2image,
        patch(
            "meridian_partition.partition.pdf_image.pdf_image_utils.annotate_layout_elements_with_image"
