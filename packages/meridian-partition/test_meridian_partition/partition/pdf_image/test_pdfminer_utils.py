...
"""
    ...
    def test_oversized_stream_returns_empty_cmap(self):
        ...
        from meridian_partition.partition.pdf_image.pdfminer_utils import _MAX_CMAP_STREAM_BYTES
...
class TestCustomPDFCIDFont:
    ...
    def test_vertical_wmode_sets_font_vertical_flag(self):
        ...
        from meridian_partition.partition.pdf_image.pdfminer_utils import CustomPDFCIDFont
