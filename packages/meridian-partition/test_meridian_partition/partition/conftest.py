...
from meridian_partition.partition.utils.constants import OCR_AGENT_PADDLE, OCR_AGENT_TESSERACT
...
def isolated_global_working_dir(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> Iterator[Path]:
    ...
    """
    from meridian_partition.partition.utils.config import get_tempdir
