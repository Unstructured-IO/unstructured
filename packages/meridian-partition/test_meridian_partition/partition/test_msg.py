"""Test suite for `meridian_partition.partition.msg` module."""
...
class DescribeMsgAttachmentFilenameSanitization:
    ...
    def it_sanitizes_path_traversal_attempts(self, request: FixtureRequest):
        from meridian_partition.partition.msg import _AttachmentPartitioner
...
class DescribeMsgPartitionerOptions:
    """Unit-test suite for `meridian_partition.partition.msg.MsgPartitionerOptions` objects."""
