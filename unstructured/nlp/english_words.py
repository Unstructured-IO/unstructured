...
***REMOVED*** NOTE(robinson) - the list of English words is based on the nlkt.corpus.words corpus
***REMOVED*** and the list of English words found here at the link below. Add more words to the text
***REMOVED*** file if needed.
