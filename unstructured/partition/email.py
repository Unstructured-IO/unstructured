...
def partition_email_header(msg: Message) -> List[Union[Element, List[Name]]]:
    elements: List[Union[Element, List[Name]]] = list()
...
def partition_email(
    ...
    header: List[Union[Element, List[Name]]] = list()
    if include_headers:
