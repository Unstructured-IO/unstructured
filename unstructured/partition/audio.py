...
from unstructured.documents.elements import Element, TranscriptFragment, ElementMetadata
...
def partition_audio(
    ...
    if deepgram_key is not None:
        ...
        raise ValueError(
            "Deepgram API key not found. No other audio partitioning methods are available."
        )
