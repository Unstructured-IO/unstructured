...
def _filter_metrics(data_input: Union[str, pd.DataFrame], filter_list: Union[str, List[str]], filter_by: str, export_filename: Optional[str] = None, export_dir: str = "metrics", return_type: Optional[str] = "dataframe"):
    ...
    if isinstance(filter_list, str):
        ...
        if filter_list.endswith(".csv"):
            filter_df = pd.read_csv(filter_list)
    ...
    if return_type == "file" and not export_filename:
