...
@click.option(
    "--dropbox-token",
    default=None,
    help="Developer token. May need to change to something else. Must be refreshed.",
)
@click.option(
    "--dropbox-folder",
    default="",
    help="Folder in dropbox. Empty string is root.",
)
@click.option(
    "--download-dir",
...
def main(
    ...
    if remote_url:
        ...
        if protocol in ("s3", "s3a"):
            ...
            from unstructured.ingest.connector.gcs import GcsConnector, SimpleGsConfig
