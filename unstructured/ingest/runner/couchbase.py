...
if t.TYPE_CHECKING:
    from unstructured.ingest.connector.couchbase import SimpleCouchbaseConfig
...
class CouchbaseRunner(Runner):
    ...
    def update_read_config(self):
        hashed_dir_name = hashlib.sha256(
            str(self.connector_config.access_config.connection_string).encode("utf-8"),
        )
        self.read_config.download_dir = update_download_dir_hash(
            connector_name="couchbase",
    ...
    def get_source_connector_cls(self) -> t.Type[BaseSourceConnector]:
        ...
        return CouchbaseSourceConnector
