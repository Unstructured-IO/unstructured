...
Partitions any valid JSON document. Serialized MeridianPartition output (a JSON array of
...
from meridian_partition.documents.elements import Element, process_metadata
