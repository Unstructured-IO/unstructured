...
from meridian_partition.documents.elements import CoordinatesMetadata, Element
from meridian_partition.logger import trace_logger
from meridian_partition.partition.utils.constants import SORT_MODE_BASIC, SORT_MODE_XY_CUT
...
def sort_page_elements(
    ...
    shrink_factor = float(
        os.environ.get("MERIDIAN_PARTITION_XY_CUT_BBOX_SHRINK_FACTOR", shrink_factor),
    )

    xy_cut_primary_direction = os.environ.get(
        "MERIDIAN_PARTITION_XY_CUT_PRIMARY_DIRECTION",
