...
from meridian_partition.partition.utils.constants import OCR_AGENT_TESSERACT, STT_AGENT_WHISPER
...
class ENVConfig:
    ...
    def GLOBAL_WORKING_PROCESS_DIR(self) -> str:
        """Path to MeridianPartition cache tempdir. Overrides TMPDIR, TEMP and TMP.
