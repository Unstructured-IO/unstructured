...
OCR_AGENT_MODULES_WHITELIST = os.getenv(
    ...
    "meridian_partition.partition.utils.ocr_models.tesseract_ocr,"
    "meridian_partition.partition.utils.ocr_models.paddle_ocr,"
    "meridian_partition.partition.utils.ocr_models.google_vision_ocr",
).split(",")
