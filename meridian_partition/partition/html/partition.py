...
from meridian_partition.documents.elements import Element, ElementType
...
from meridian_partition.partition.html.parser import Flow, html_parser
...
class _HtmlPartitioner:
    ...
    def _from_ontology(self) -> List[Element]:
        ...
        meridian_partition_elements = ontology_to_meridian_partition_elements(
            ontology, add_img_alt_text=self._opts.add_img_alt_text
        )
        return meridian_partition_elements
