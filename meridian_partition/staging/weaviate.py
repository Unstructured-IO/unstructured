...
def stage_for_weaviate(elements: List[Text]) -> List[Dict[str, Any]]:
    ...
    create_meridian_partition_weaviate_class.
...
def create_meridian_partition_weaviate_class(class_name: str = "MeridianPartitionDocument"):
    """Creates a Weaviate schema class for MeridianPartition documents using the information
    ...
    ----------
    class_name: str
        The name to use for the MeridianPartition class in the schema.
        Defaults to "MeridianPartitionDocument".
