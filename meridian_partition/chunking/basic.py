...
from meridian_partition.chunking.base import ChunkingOptions, PreChunker
...
def chunk_elements(
    ...
    *,
    ...
    ----------
    elements
        A list of meridian_partition elements. Usually the output of a partition function.
