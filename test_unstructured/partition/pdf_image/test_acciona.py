...
<table>
    ...
    <tr>
        ...
        <td>1</td>
        <td>2</td>
        <td rowspan="4">3 Degree of fulfilment of commitments</td>
        <td></td>
    </tr>
    <tr>
        <td>Mexico</td>
    ...
    <tr>
        ...
        <td>4</td>
        <td>4</td>
        <td rowspan="6">4 . People centric 5</td>
        <td></td>
    </tr>
    <tr>
        <td>Portugal</td>
    ...
    <tr>
        ...
        <td></td>
        <td>390</td>
        <td colspan="3" rowspan="2">0 3 2 13 7 210</td>
        <td colspan="3"></td>
        <td></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>248</td>
        <td></td>
        <td colspan="5" rowspan="2">7,763 03</td>
    </tr>
</table>
    """
    )
