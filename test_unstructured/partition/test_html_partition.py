...
def test_partition_html_with_include_element_types(
...
def test_partition_html_with_exclude_element_types(
    filename="example-docs/winter-sports.epub",
):
    element_types = [HTMLTitle]
    elements = partition_html(
...
def test_partition_html_from_file_with_include_element_types(
    filename="example-docs/winter-sports.epub",
):
    element_types = [HTMLTitle]
    with open(filename, "rb") as f:
...
def test_partition_html_from_file_with_exclude_element_types(
    filename="example-docs/winter-sports.epub",
):
    element_types = [HTMLTitle]
    with open(filename, "rb") as f:
