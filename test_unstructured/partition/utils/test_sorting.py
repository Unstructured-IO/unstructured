...
from unstructured.documents.elements import Element, CoordinatesMetadata, Text
...
def test_sort_xycut_neg_coordinates():
    ...
    for idx in range(2):
        elem = Text(str(idx))
        elem.metadata.coordinates = CoordinatesMetadata([(-idx, 2), (3, 4), (6, 7), (8, 9)], PixelSpace)
...
def test_sort_basic_neg_coordinates():
    ...
    for idx in range(3):
        elem = Text(str(idx))
        elem.metadata.coordinates = CoordinatesMetadata([(1, -idx), (3, 4), (6, 7), (8, 9)], PixelSpace)
        elements.append(elem)
