...
def test_partition_rtf_with_include_element_types(
...
def test_partition_rtf_with_exclude_element_types(
    filename="example-docs/fake-doc.rtf",
):
    element_types = [HTMLTitle]
    elements = partition_rtf(
...
def test_partition_rtf_from_file_with_include_element_types(
    filename="example-docs/fake-doc.rtf",
):
    element_types = [HTMLTitle]
    with open(filename, "rb") as f:
...
def test_partition_rtf_from_file_with_exclude_element_types(
    filename="example-docs/fake-doc.rtf",
):
    element_types = [HTMLTitle]
    with open(filename, "rb") as f:
