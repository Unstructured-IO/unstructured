...
def test_partition_html_can_suppress_metadata():
...
def test_partition_html_pulls_last_modified_from_filesystem_when_file_path_is_used(
...
def test_partition_html_does_not_pull_last_modified_from_file_like_object_by_default(
