...
def test_calculate_edit_distance():
    ...
    assert round(calculate_edit_distance(source_cct_word_space, source_cct, return_as="score"), 2) == 0.75
    assert round(calculate_edit_distance(source_cct_spaces, source_cct, return_as="score"), 2) == 0.39
    assert round(calculate_edit_distance(source_cct_no_space, source_cct, return_as="score"), 2) == 0.64
    assert round(calculate_edit_distance(source_cct_one_sentence, source_cct, return_as="score"), 2) == 0.0
    assert round(calculate_edit_distance(source_cct_missing_word, source_cct, return_as="score"), 2) == 0.57
    assert round(calculate_edit_distance(source_cct_addn_char, source_cct, return_as="score"), 2) == 0.89
    assert round(calculate_edit_distance(source_cct_dup_word, source_cct, return_as="score"), 2) == 0.79
