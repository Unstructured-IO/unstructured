...
def test_break_by_line_break():
    raw_html = """<html>
    <td>
    <a href="index.html">
        <img src="https://sep.yimg.com/ca/I/paulgraham_2271_3232" width="410" height="45" border="0" hspace="0" vspace="0"/>
    </a>
    <br/>
    <br/>
    <table border="0" cellspacing="0" cellpadding="0" width="435">
        <tr valign="top">
        <td width="435">
            <img src="https://s.yimg.com/aah/paulgraham/how-to-get-new-ideas-1.gif" width="176" height="18" border="0" hspace="0" vspace="0" alt="How to Get New Ideas"/>
            <br/>
            <br/>
            <font size="2" face="verdana">January 2023<br/><br/><i>(<a href="https://twitter.com/stef/status/1617222428727586816"><u>Someone</u></a> fed my essays into GPT to make something that could answer
    ...
    whole new fractal buds.<br/><br/></font>
        </td>
        </tr>
    </table>
    <table border="0" cellspacing="0" cellpadding="0" width="435">
