...
docker-test:
	...
	$(DOCKER_IMAGE) \
	CI=$(CI) UNSTRUCTURED_INCLUDE_DEBUG_METADATA=$(UNSTRUCTURED_INCLUDE_DEBUG_METADATA) /home/nonroot/.local/pytest -m 'not chipper' $(if $(TEST_FILE),$(TEST_FILE),test_unstructured)"
