...
test:
	PYTHONPATH=. CI=$(CI) \
	UNSTRUCTURED_INCLUDE_DEBUG_METADATA=$(UNSTRUCTURED_INCLUDE_DEBUG_METADATA) pytest -m "not integration" test_${PACKAGE_NAME} --cov=${PACKAGE_NAME} --cov-report term-missing
