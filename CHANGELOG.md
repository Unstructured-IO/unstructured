...
* **Ingest tests cleanup** As part of the ingest test process, new files and directories are created to hold generated content. All scripts are updated to delete that generated content by default.
