...
* **Fix PDF attempt to get dict value from string.** The PDF annotation as a string got overwrite as `None`, then skip an attempt to extract URI from the `None` value.
