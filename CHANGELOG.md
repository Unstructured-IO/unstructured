...
- **Truncate text if it exceeds `spacy` limit**: add a gaurd against calling `spacy` tokenizer with very long text. Now long text are truncated to fit under the character limit.
