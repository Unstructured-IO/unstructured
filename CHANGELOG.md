...
* **Improve `xy-cut` sorting by pre/post processing bboxes**. The new behavior is to shrink all bounding boxes by 90% along x and y axes (still centered around the same center point).
