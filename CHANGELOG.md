...
* **Remove deprecated `overwrite_schema` kwage from Delta Table connector.**. The `overwrite_schema` kwarg is deprecated in `deltalake>=0.18.0`. `schema_mode="merge"` should be used now instead.
