...
* Adds data source properties (date_created, date_modified, version, exists, source_url, record_locator) to Onedrive, Slack and Reddit connectors. Adds `update_source_metadata` method to onedrive, reddit and slack connectors. 
