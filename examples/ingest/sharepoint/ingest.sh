...
# To setup your application and obtain permissions related variables (--permissions-application-id, --permissions-client-cred, --permissions-tenant), follow these steps:
...
PYTHONPATH=. ./unstructured/ingest/main.py \
    ...
    --permissions-application-id "<Microsoft Graph API application id>" \
    --permissions-client-cred "<Microsoft Graph API application credentials>" \
    --permissions-tenant "<e.g https://contoso.onmicrosoft.com to process permission info within tenant>" \
