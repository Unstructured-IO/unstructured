...
.. tabs::
   ...
   .. tab:: Shell
      ...
      .. literalinclude:: ./code/bash/salesforce.sh
         :language: bash

   .. tab:: Python

      .. literalinclude:: ./code/python/salesforce.py
         :language: python
...
.. tabs::
   ...
   .. tab:: Shell
      ...
      .. literalinclude:: ./code/bash/salesforce_api.sh
         :language: bash

   .. tab:: Python

      .. literalinclude:: ./code/python/salesforce_api.py
         :language: python
