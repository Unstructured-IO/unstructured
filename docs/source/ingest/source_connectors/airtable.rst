...
.. tabs::
   ...
   .. tab:: Shell
      ...
      .. literalinclude:: ./code/bash/airtable.sh
         :language: bash

   .. tab:: Python

      .. literalinclude:: ./code/python/airtable.py
         :language: python
...
.. tabs::
   ...
   .. tab:: Shell
      ...
      .. literalinclude:: ./code/bash/airtable_api.sh
         :language: bash

   .. tab:: Python

      .. literalinclude:: ./code/python/airtable_api.py
         :language: python
