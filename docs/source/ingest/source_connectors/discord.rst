...
.. tabs::
   ...
   .. tab:: Shell
      ...
      .. literalinclude:: ./code/bash/discord.sh
         :language: bash

   .. tab:: Python

      .. literalinclude:: ./code/python/discord.py
         :language: python
...
.. tabs::
   ...
   .. tab:: Shell
      ...
      .. literalinclude:: ./code/bash/discord_api.sh
         :language: bash

   .. tab:: Python

      .. literalinclude:: ./code/python/discord_api.py
         :language: python
