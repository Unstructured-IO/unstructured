...
function cleanup() {
	...
	docker-compose -f scripts/opensearch-test-helpers/docker-compose.yaml down --remove-orphans -v
...
# scripts/opensearch-test-helpers/create-and-check-opensearch.sh
# wait
