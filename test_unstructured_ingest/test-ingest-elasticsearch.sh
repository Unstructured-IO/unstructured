...
container_id=$(<"test_unstructured_ingest/test-ingest-elasticsearch-docker_container_id.txt")
rm test_unstructured_ingest/test-ingest-elasticsearch-docker_container_id.txt
