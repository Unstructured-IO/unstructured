...
from meridian_partition.safe_http import (
    UnsafeURLError,
    _is_cross_origin,
    _is_ip_blocked,
    _normalize_hostname,
...
class Describe_validate_url:
    ...
    @patch("meridian_partition.safe_http.socket.getaddrinfo")
    ...
    def test_skips_validation_with_env_var(self, monkeypatch):
        monkeypatch.setenv("MERIDIAN_PARTITION_ALLOW_PRIVATE_URL", "1")
...
class Describe_safe_create_connection:
    ...
    @patch("meridian_partition.safe_http.socket.socket")
    @patch("meridian_partition.safe_http.socket.getaddrinfo")
...
class Describe_safe_get:
    @patch("meridian_partition.safe_http.socket.getaddrinfo")
    @patch("meridian_partition.safe_http.requests.Session")
