...
"""Test suite for the `meridian_partition.chunking.title` module."""
...
class Describe_chunk_by_title:
    """Unit-test suite for `meridian_partition.chunking.title.chunk_by_title()` function."""
    ...
    def _chunk_by_title_(self, request: FixtureRequest):
        return function_mock(request, "meridian_partition.chunking.title._chunk_by_title")


class Describe_ByTitleChunkingOptions:
    """Unit-test suite for `meridian_partition.chunking.title._ByTitleChunkingOptions` objects."""
