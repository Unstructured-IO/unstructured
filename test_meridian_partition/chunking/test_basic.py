"""Test suite for the `meridian_partition.chunking.basic` module.
...
class Describe_chunk_elements:
    """Unit-test suite for `meridian_partition.chunking.basic.chunk_elements()` function."""
    ...
    def _chunk_elements_(self, request: FixtureRequest):
        return function_mock(request, "meridian_partition.chunking.basic._chunk_elements")
