...
"""Test-suite for the `meridian_partition.partition.xlsx` module."""
...
class Describe_XlsxPartitionerOptions:
    """Unit-test suite for `meridian_partition.partition.xlsx._XlsxPartitionerOptions` objects."""
    ...
    def get_last_modified_date_(self, request: FixtureRequest):
        return function_mock(request, "meridian_partition.partition.xlsx.get_last_modified_date")
...
class Describe_ConnectedComponent:
    """Unit-test suite for `meridian_partition.partition.xlsx._ConnectedComponent` objects."""
...
class Describe_SubtableParser:
    """Unit-test suite for `meridian_partition.partition.xlsx._SubtableParser` objects."""
