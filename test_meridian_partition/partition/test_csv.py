...
class Describe_CsvPartitioningContext:
    """Unit-test suite for `meridian_partition.partition.csv._CsvPartitioningContext`."""
    ...
    def get_last_modified_date_(self, request: FixtureRequest) -> Mock:
        return function_mock(request, "meridian_partition.partition.csv.get_last_modified_date")
